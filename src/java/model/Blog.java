...
public class Blog {
    ...
    public Blog(int id, String banner, String blogTitle, String blogCategory, String body,
            String img1, Date createDate, int viewCount, boolean status, BlogCategory blogCategoryObject) {
        this.id = id;
        this.banner = banner;
        this.blogTitle = blogTitle;
        this.blogCategory = blogCategory;
